...
CREATE_STMT_PATH = os.path.join(
    UTILS_PATH, "create_statement_s3_exporting_lua_script.sql")
CREATE_STMT_TEMPLATE_PATH = os.path.join(
...
class S3ExportingLuaScriptCreateStatementGenerator(BaseCreateStatementGenerator):
    ...
    def __init__(self):
        ...
        self._modules = [
            ...
            "exaerror",
            "message_expander"]
        self._create_statement_path = CREATE_STMT_PATH
        ...
        super().__init__(
            ...
            create_statement_path=self._create_statement_path,
